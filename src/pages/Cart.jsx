                ...
                products.length > 0 ? (
                    <div className='container mx-auto h-auto grid grid-cols-5 gap-8'>
                        ...
                        <div className='w-full h-full bg-white col-span-4 px-4'>
                            ...
                            {/* ________________ cart products */}
                            <div>
                                {
                                    products.map(item => (
                                            ...
                                            <div className="w-full flex flex-col md:flex-row items-center gap-6">
                                                ...
                                                <div className="w-full flex flex-col gap-2 xl:gap-1">
                                                    ...
                                                    <div className='bg-[#f0f2f2] flex justify-center items-center gap-2 w-36 py-1 text-center drop-shadow-lg rounded-md'>
                                                        ...
                                                        <p onClick={() => { dispatch(decreaseQuantity(item.id)) }} className='cursor-pointer bg-gray-200 px-1 rounded-md hover:bg-gray-400 font-semibold duration-300'>-</p>
                                                        <p>{item.quantity}</p>
                                                        <p onClick={() => { dispatch(increaseQuantity(item.id)) }} className='cursor-pointer bg-gray-200 px-1 rounded-md hover:bg-gray-400 font-semibold duration-300'>+</p>
                                                    </div>
                            ...
                            <div>
                                ...
                                <div>
                                    <p className="font-semibold px-6 py-1 flex items-center justify-between">
                                        Total: <span className="text-lg font-bold">${totalAmount}</span>
                                    </p>
                                </div>
